  ...
  export default {
    ...
    methods: {
      ...
      onDecode(decodedString) {
        ...
        // store decoded string in local storage as onlineTicketId
        localStorage.setItem('onlineTicketId', this.decodedString);
        // then redirect to PhysicalTicketTag.vue
        this.$router.push('/tag-physical-ticket');
      },
      dismissModal() {
        this.resetState();
        this.startScanning();
