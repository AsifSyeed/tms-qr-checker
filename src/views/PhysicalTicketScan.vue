    ...
    methods: {
        async onInit(promise) {
            try {
                ...
                // receive data from previous page this.$router.push({ name: 'ScanPhysicalTicket', params: { data: data } });
        ...
        async verifyTicket() {
            try {
                ...
                const request = {
                    ...
                    // get eventId from local storage
                    eventId: localStorage.getItem('eventId')
                };

                const url = 'https://api.countersbd.com/api/v1/ticket/sell-physical-ticket';
